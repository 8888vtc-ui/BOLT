    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 backgammon-pattern relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          {error && (
            <div className="p-4 bg-red-500/20 border border-red-500 rounded-xl text-red-500 text-sm">
              {error}
            </div>
          )}
          ...
          {isRegister && (
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-12 pr-4 py-4 bg-black border-2 border-gray-800 focus:border-[#FFD700] rounded-xl text-white placeholder-gray-500 outline-none transition-colors"
              />
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#FFD700] hover:bg-[#FFC700] text-black font-bold py-5 px-8 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_40px_rgba(255,215,0,0.3)] hover:shadow-[0_0_60px_rgba(255,215,0,0.5)] transform hover:scale-[1.02]"
          >
          ...
          <button
            ...
            className="w-full text-gray-400 hover:text-[#FFD700] transition-colors text-sm"
          >
